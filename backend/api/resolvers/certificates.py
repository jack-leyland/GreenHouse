...
def create_certificate(data):
    ...
    certificate.hot_water_cost_potential = verify_number(data["hot-water-cost-potential"])
    ...
    certificate.environment_impact_potential = verify_number(data["environment-impact-potential"])
    ...
    certificate.fixed_lighting_outlets_count = verify_number(data["fixed-lighting-outlets-count"])
    ...
    certificate.energy_consumption_potential = verify_number(data["energy-consumption-potential"])
    ...
    certificate.co2_emiss_curr_per_floor_area = verify_number(data["co2-emiss-curr-per-floor-area"])
    ...
    certificate.environment_impact_current = verify_number(data["environment-impact-current"])
    ...
    certificate.current_energy_efficiency = verify_number(data["current-energy-efficiency"])
    certificate.energy_consumption_current = verify_number(data["energy-consumption-current"])
    ...
    certificate.potential_energy_efficiency = verify_number(data["potential-energy-efficiency"])
