...
def create_timeseries(data):
    ...
    results.average_annual_change_walls_environmental_eff = averages_dict["WALLS_ENV_EFF"]
    results.average_annual_change_water_energy_eff = averages_dict["HOT_WATER_ENERGY_EFF"]
    results.average_annual_change_water_environmental_eff = averages_dict["HOT_WATER_ENV_EFF"]
    results.average_annual_change_floor_energy_eff = averages_dict["FLOOR_ENERGY_EFF"]
    results.average_annual_change_floor_environmental_eff = averages_dict["FLOOR_ENV_EFF"]
