...
class Timeseries(ObjectType):
    ...
    average_timeseries_walls_energy_eff = Float()
    average_timeseries_walls_environmental_eff = Float()
    average_timeseries_water_energy_eff = Float()
    average_timeseries_water_environmental_eff = Float()
    average_timeseries_floor_energy_eff = Float()
    average_timeseries_floor_environmental_eff = Float()
    average_timeseries_roof_energy_eff = Float()
    average_timeseries_roof_environmental_eff = Float()
    average_timeseries_main_heating_energy_eff = Float()
    average_timeseries_main_heating_environmental_eff = Float()
    average_timeseries_main_heating_controls_energy_eff = Float()
    average_timeseries_main_heating_controls_environmental_eff = Float()
    average_timeseries_second_heating_energy_eff = Float()
    average_timeseries_second_heating_environmental_eff = Float()
    average_timeseries_windows_energy_eff = Float()
    average_timeseries_windows_environmental_eff = Float()
