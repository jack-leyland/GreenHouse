  ...
  return (
    <div className="py-2 px-1 h-full">
        ...
        <div className="w-5/12">
            ...
            <span className="mr-2">CO<sub>2</sub> Production</span>
            <ReactTooltip
                effect='solid'
            />
            <a
            data-tip="The amount of carbon dioxide produced by your house in kg/year"
            >
                <AiFillQuestionCircle size={10}/>
            </a>
            </div>
            <div className="h-full flex justify-center items-center pt-8">
                <BarChart layout="horizontal" width={150} height={175} data={carbonData}>
        ...
        <div className="w-7/12 border border-r-0 border-y-0">
            ...
            <div className="px-4 py-1">
                ...
                <div className="py-1">After implementing improvements you could reduce your emssions to {potentialEmissions} </div>
                <div className="py-1">This C0<sub>2</sub> reduction is equivalent to ...</div>
            </div>
            </div>
        </div>
        </div>
