      ...
      <div className="flex h-3/4">
        ...
        <div className="w-1/3 border border-y-0 h-full pl-2 flex flex-col gap-1">
          ...
          <div className="flex gap-2 flex-col h-full">
            ...
            <div className="h-1/3">
              <div className="py-1 underline">In Your Area</div>
              In your area, the average person pays <i>{analytics?.meanCurrentHotWaterCost} £/year</i> on hot water.
            </div>
          </div>
        ...
        <div className="w-1/3 h-full pl-1 flex flex-col gap-1">
          ...
          <div className="flex gap-2 flex-col h-full">
            ...
            <div className="h-1/3">
              <div className="py-1 underline">In Your Area</div>
              In your area, the average person pays <i>{analytics?.meanCurrentLightingCost} £/year</i> on lighting.
            </div>
          </div>
        </div>
      </div>
