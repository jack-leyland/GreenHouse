        ...
        <div className="w-1/3 h-full px-1 flex flex-col gap-2">
          ...
          <div className="flex gap-2 flex-col h-full">
            <div className="h-2/3 flex flex-col gap-2 w-full py-1 border border-x-0 border-t-0">
              ...
              <div>In your area, the average person pays <i>{analytics?.meanCurrentHeatingCost} £/year</i> on heating.</div>
            </div>
        ...
        <div className="w-1/3 border border-y-0 h-full px-2 flex flex-col gap-2">
          ...
          <div className="flex gap-2 flex-col h-full">
            <div className="h-2/3 flex flex-col gap-2 w-full py-1 border border-x-0 border-t-0">
              ...
              <div>In your area, the average person pays <i>{analytics?.meanCurrentHotWaterCost} £/year</i> on hot water.</div>
            </div>
            <div className="h-1/3">
        ...
        <div className="w-1/3 h-full px-2 flex flex-col gap-2">
          ...
          <div className="flex gap-2 flex-col h-full">
            <div className="h-2/3 flex flex-col gap-2 w-full py-1 border border-x-0 border-t-0">
              ...
              <div>In your area, the average person pays <i>{analytics?.meanCurrentLightingCost} £/year</i> on lighting.</div>
              </div>
            <div className="h-1/3">
