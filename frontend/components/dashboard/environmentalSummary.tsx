          ...
          <div className="min-h-full flex flex-col pt-1 px-1">
            <div className="border border-x-0 border-t-0">
              <div className="pb-2 text-sm">
                ...
                <b>{data.energyConsumptionCurrent}</b> kWh/year
              </div>
              <div className="pb-2 text-sm">
            ...
            <div className="pt-3">
              ...
              <b>
                {data.energyConsumptionCurrent -
                  data.energyConsumptionPotential}{" "}
              </b>
            ...
            <div className="flex w-full justify-center gap-2 py-5">
              <div className="flex flex-col justify-center items-center w-1/3">
                ...
                <p className="text-center italic">
                  ...
                  {phoneCharges > 1 ? "charges" : "charge"} charges
                </p>
              </div>
              <div className="flex flex-col justify-center items-center w-1/3">
                ...
                <p className="text-center italic">
                  ...
                  {carJourneys > 1 ? "journeys" : "journey"} journeys
                </p>
              </div>
              <div className="flex flex-col justify-center items-center w-1/3">
