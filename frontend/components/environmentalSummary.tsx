...
import {Legend, RadarChart, Radar, PolarRadiusAxis, PolarAngleAxis, PolarGrid} from 'recharts';
    ...
    <div className="flex h-3/4">
      <div className="w-7/12">
        <div className="h-full flex flex-col pt-1 px-1">
            ...
            <div className="pb-2">
              Energy Consumption Potential: {energyConsumptionPotential} kWh/year
            </div>
            <div className="pt-1">
              You can potentially reduce your energy consumption by {energyConsumptionCurrent - energyConsumptionPotential} kWh/year.
      ...
      <div className="w-5/12 border border-r-0 border-y-0">
        <div className="flex items-center mx-2">
          ...
          />
          <a
          data-tip="Each component of your house is given an environmental efficiency rating out of 5"
          >
              <AiFillQuestionCircle size={10}/>
          </a>
        </div>
        <div className="flex justify-center align-center">
          <RadarChart outerRadius={40} width={200} height={150} data={featureData}>
            <PolarGrid />
            <PolarAngleAxis dataKey="feature" />
            <PolarRadiusAxis angle={30} domain={[0, 5]} />
            <Radar name="Environmental Efficiency" dataKey="rank" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
            <Legend />
          </RadarChart>
        </div>
      </div>
