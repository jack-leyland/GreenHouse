...
export default function RecCardGallery({ data }: props) {
  ...
  return (
    <div className="relative w-full h-full flex-row justify-center">
      <div className="w-full h-[50px] flex justify-center border-2 border-black">
      ...
      <div className="flex justify-center animate-fade border-2 border-red-400 ">
        {" "}
        <div className="w-[95%] flex flex-wrap justify-center items-center mt-2 sm:flex-row flex-col border-2 border-black">
