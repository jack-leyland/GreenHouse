...
import {ResponsiveContainer, CartesianGrid, BarChart, Bar, XAxis, YAxis, Cell, Tooltip, Legend} from "recharts"
        ...
        [
          {
            ...
            lightingEnv: data.bigQuery.averageAnnualChangeLightingEnvironmentalEff,
            ...
            heatingEnv: data.bigQuery.averageAnnualChangeMainHeatingEnvironmentalEff,
            heatingContEng: data.bigQuery.averageAnnualChangeMainHeatingControlsEnergyEff,
            heatingContEnv: data.bigQuery.averageAnnualChangeMainHeatingControlsEnvironmentalEff,
            heatingSecEng: data.bigQuery.averageAnnualChangeSecondHeatingEnergyEff,
            heatingSecEnv: data.bigQuery.averageAnnualChangeSecondHeatingEnvironmentalEff,
